...
import { employmentOptions, initSelectBottom, initValues, occupation1Options, SELECT_TYPE, selectBottomTypeMapField, selectBottomTypeWithField } from './constants';
      ...
      <div className="change-profile__content">
        <div className="profile__avatar__wrapper">
          <div className="profile__avatar">
            ...
            <div className="btn__setting" onClick={onOpenChangePhotoBottom}>
              <SettingIcon />
            </div>
          </div>
          <div>
            <Button label="Delete" variant="outlined__gray" className="btn__delete btn__sm" onClick={onClickDeletePhoto}></Button>
          </div>
        </div>
        <div className="form__wrapper">
          <div className="form__section">
            ...
            />
            <Controller
              render={({ field }) => <Dropdown label={'Employment'} onFocus={onOpenSelectEmploymentBottom} options={employmentOptions} {...field} />}
              control={control}
              name="employment"
            />
            <Controller
              render={({ field }) => <Dropdown label={'Occupation1'} onFocus={onOpenSelectOccupation1Bottom} options={occupation1Options} {...field} />}
              control={control}
              name="occupation1"
            />
            <Controller
          ...
          <div className="form__section pt-9">
            ...
            <Controller
              ...
              name="country"
            />
            <div className="divider__item__solid mt-4"></div>
        ...
        <div className="footer__fixed">
          <Button label="Save" variant="filled__primary" className="btn__cta" onClick={handleSubmit(onSubmitSaveForm)}></Button>
        </div>
      </div>
