        ...
        <div className='branch-directory__content'>
          <div className='branch-directory__list'>
            {branchDirectoryListTest.map((branch, index) => (
              <div className='branch-directory__item' key={`${branch.branchNo}-${index}`}>
                  ...
                  <div className='accordion__table__bottom'>
                    <div className='table__info'>
                      {branchFields.map(({ label, value }) => (
                        <div className='table__item' key={`${value}-${index}`}>
                    ...
                    <div className='accordion__ctas'>
                      <Button label="View map" variant="outlined__primary" size="md" onClick={() => handleOpenViewMap(branch)}></Button>
                      <Button label="Book Appointment" variant="filled__primary" size="md" onClick={() => handleBookAppointment()}></Button>
                    </div>
                  </div>
                </Accordion>
              </div>
