  ...
  return (
    <>
      <div className='book-appointment-successful__wrapper'>
        ...
        <div className='book-appointment__info'>
          {bookAppointmentSuccessFields.map(({label, value}) => 
            <div className='appointment-item' key={value}>
      ...
      <div className='footer__fixed'>
        <Button variant="filled__secondary-blue" label="View Appointment" className="btn__cta" onClick={onClickViewAccount}></Button>
        <Button variant="filled__primary" label="Done" className="btn__cta" onClick={onClickNavigateHome}></Button>
      </div>
    </>
  );
};
