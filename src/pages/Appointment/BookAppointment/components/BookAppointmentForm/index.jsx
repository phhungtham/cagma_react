      ...
      <div className='page__wrapper'>
        ...
        <div className='book-appointment__content'>
          <div className='book-appointment__form page__container'>
            <h1 className='page__title'>{type === BookAppointmentType.IN_PERSON ? 'In person Appointment' : 'Zoom Appointment'} </h1>
            <section className='mt-4'>
              <TextDropdown label="Customer type" placeholder="Select" onClick={handleOpenCustomerTypeBottom} value={customerType?.label}>
              </TextDropdown>
            </section>
            <section >
              <TextDropdown label="Purpose of Appointment" placeholder="Select" onClick={handleOpenPurposeAppointmentBottom} value={selectedPurpose?.label}>
                {selectedPurpose && <div className='purpose__detail'>{selectedPurpose.detail}</div>}
              </TextDropdown>
            </section>
            <section>
              <TextDropdown label="Date" placeholder="Select" onClick={handleOpenSelectDateBottom}>
              </TextDropdown>
            </section>
            <section>
              <TextDropdown 
            ...
            <div className='divider__item__solid my-4'></div>
            <section>
              <TextDropdown 
          ...
          <div className="footer__fixed">
            <Button label="Reserve" variant="filled__primary" className="btn__cta" onClick={handleSubmit(onSubmitBookAppointment)}></Button>
          </div>
        </div>
      </div>
