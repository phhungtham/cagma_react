    ...
    <>
      {bannerType === 'vertical' && (
        <div className={`card_vertical_banner ${clazz} ${renderBannerBackground(cardType)}`}>
          ...
          <section className={`banner_bottom ${renderBannerBackground(cardType)}`}>
            <div className="data">
              ...
              <div className="data_value">
                <Span
                  clazz="currency"
                  text={amountLimit?.value}
                />
                <Span
                  clazz="unit"
                  text={amountLimit?.unit}
                />
              </div>
            </div>
            <div className="data">
          ...
          {cardType === 2 && (
            <img
              className="banner_vertical_img_sub"
              src={cardImageSub}
              alt="banner_vertical_img"
            />
          )}
          <img
            className="banner_vertical_img"
            src={cardImage}
            alt="banner_vertical_img"
          />
        </div>
        ...
        <div className={`card_horizontal_banner ${clazz} ${renderBannerBackground(cardType)}`}>
          ...
          <section className="card_data">
            <div className="data_item">
              ...
              <Span
                clazz="value"
                text={`${amountLimit?.value} ${amountLimit?.unit || ''}`}
              />
            </div>
            <div className="data_item">
              <Span
              ...
              <Span
                clazz="value"
                text={annualFee.value + (annualFee.unit || '')}
              />
              {textPromotion !== '' && (
                <Span
                  clazz="fee_promotion"
          ...
          {cardType === 2 && (
            <img
              className="banner_horizontal_img_sub"
              src={cardImageSub}
              alt="banner_horizontal_img"
            />
          )}
          <img
            className="banner_horizontal_img"
            src={cardImage}
            alt="banner_horizontal_img"
          />
          <div className="card_horizontal_shadow" />
        </div>
      )}
    </>
  );
