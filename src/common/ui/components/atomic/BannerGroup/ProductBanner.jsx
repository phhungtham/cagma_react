  ...
  const footerJSX = () => {
    return type === 'detail' ? (
      <div className="banner__footer">
        <div className="left">
          <Span clazz="title" text={footerLeft.title} />
          <div className="footer__params">
            <Span clazz="params" text={footerLeft.params} />
            <Span clazz="unit" text={footerLeft.unit} />
          </div>
        </div>
        <span className="divider"></span>
        <div className="right">
          <Span clazz="title" text={footerRight.title} />
          <div className="footer__params">
            <Span clazz="params" text={`${footerRight.params}${footerRight.unit} `} />
          </div>
        </div>
      </div>
    ) : (
      <div className="list__bottom">
        <div className="left">
          <Span clazz="params" text={`${footerLeft.params} ${footerLeft.unit} `} />
        </div>
        <div className="right">
  ...
  return (
    <div className={`product__banner ${type} ${clazz}`}>
      <div className={`product__banner__content ${type}`}>
        {type === 'compact' && <Span clazz={`product__banner__label ${type}`} text={label} />}
        <Span clazz={`product__banner__heading ${type}`} text={heading} />
        <Span clazz={`product__banner__desc ${type}`} text={description} />
      </div>
      {type === 'compact' && (
